...
const CollectionsContainer = (props: Props) => {
  ...
  return (
    <div className="pt-20">
      <div
        className={`bg-white  flex items-center px-5 md:px-12 justify-between fixed z-30 h-16 w-full  shadow-sm ${
      ...
      >
        ...
        <Drawer direction="right">
          ...
          <DrawerContent className="h-full mt-0 w-full lg:w-2/4 inset-y-0 inset-x-auto right-0">
            <div className="p-10 lg:p-28 space-y-8 overflow-y-scroll overflow-x-hidden">
